...
$rjioDgEb = "";
if(strtotime($firstDate) < strtotime($compDate)){
	$rjioDgEb = "SUM(`DG_CPH_Cabex` * `DGRate` * `DGHrs` * `NoOfDays` + `DG_Billing_Amt`) as rjio_dg_amount, 
	SUM(`EB_CPH_Cabex` * `EBRate` * `EBHrs` * `NoOfDays` + `EB_Billing_Amt`) as rjio_eb_amount ";
}
else{
	$rjioDgEb = "SUM(`Cabex_DG` + `DG_Billing_Amt`) as rjio_dg_amount, SUM(`Cabex_EB` + `EB_Billing_Amt`) as rjio_eb_amount ";
}
...
(case when `Operator Name` = 'Pulse Telesystem' then `BTS1_BTS on air Date` else '..' end) as ttslCDMA_on_air_date, '..' as ttslCDMA_off_date, (case when `Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`Total Load` else '..' end) as ttslCDMA_load, 
...
(case when `Operator Name` = 'Pulse Telesystem' then `Total Average Aircon Load at Site` else '..' end) as ttslCdma_Aircon_Load_in_KW,
...
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS1_BTS OFF Date` end) ttslCdma_bts1_off_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS2_BTS OFF Date` end) ttslCdma_bts2_off_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS3_BTS OFF Date` end) ttslCdma_bts3_off_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS4_BTS OFF Date` end) ttslCdma_bts4_off_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS5_BTS OFF Date` end) ttslCdma_bts5_off_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS6_BTS OFF Date` end) ttslCdma_bts6_off_date,
...
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS1_BTS type (ID/OD)` end) ttslCdma_bts1_type,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS2_BTS type (ID/OD)` end) ttslCdma_bts2_type,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS3_BTS type (ID/OD)` end) ttslCdma_bts3_type,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS4_BTS type (ID/OD)` end) ttslCdma_bts4_type,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS5_BTS type (ID/OD)` end) ttslCdma_bts5_type,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS6_BTS type (ID/OD)` end) ttslCdma_bts6_type,
...
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS2_BTS on air Date` end) ttslCdma_bts2_on_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS3_BTS on air Date` end) ttslCdma_bts3_on_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS4_BTS on air Date` end) ttslCdma_bts4_on_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS5_BTS on air Date` end) ttslCdma_bts5_on_date,
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`BTS6_BTS on air Date` end) ttslCdma_bts6_on_date,
...
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`Link on air Date` end) ttslCdma_link_on_date,
...
(case when `VIL_Site_Master`.`Operator Name` = 'Pulse Telesystem' then `VIL_Site_Master`.`Link OFF Date` end) ttslCdma_link_off_date,
...
while($row = mysqli_fetch_assoc($result)){
	...
	// ---------------------------------
	// as discuss on 20 sep 21; all AC load will be 0.
	$airtelAircon = $airtelAircon * 0; 
	$bsnlAircon = $bsnlAircon * 0; 
	$ideaAircon = $ideaAircon * 0; 
	$pbHfclAircon = $pbHfclAircon * 0; 
	$rjioAircon = $rjioAircon * 0;
	$sifyAircon = $sifyAircon * 0; 
	$tclIotAircon = $tclIotAircon * 0; 
	$tclNldAircon = $tclNldAircon * 0; 
	$tclRedwinAircon = $tclRedwinAircon * 0;
	$tclWimaxAircon = $tclWimaxAircon * 0; 
	$ttslCdmaAircon = $ttslCdmaAircon * 0; 
	$ttslAircon = $ttslAircon * 0;
	$vodafoneAircon = $vodafoneAircon * 0;
	// ---------------------------------
	...
	$airtelTenancy = prepareNoOfTenancy($period, $firstDate, $airtel_on_date, $airtelOffDate, $airtelEnergyRevenue);
	$bsnlTenancy = prepareNoOfTenancy($period, $firstDate, $bsnl_on_date, $bsnlOffDate, $bsnlEnergyRevenue);
	$ideaTenancy = prepareNoOfTenancy($period, $firstDate, $idea_on_date, $ideaOffDate, $ideaEnergyRevenue);
	$pbHfclTenancy = prepareNoOfTenancy($period, $firstDate, $pbHFCL_on_date, $pbHFCLOffDate, $pbHfclEnergyRevenue);
	$rjioTenancy = prepareNoOfTenancy($period, $firstDate, $rjio_on_date, $rjioOffDate, $rjioEnergyRevenue);
	$sifyTenancy = prepareNoOfTenancy($period, $firstDate, $sify_on_date, $sifyOffDate, $sifyEnergyRevenue);
	$tclIotTenancy = prepareNoOfTenancy($period, $firstDate, $tclIot_on_date, $tclIotOffDate, $tclIotEnergyRevenue);
	$tclNldTenancy = prepareNoOfTenancy($period, $firstDate, $tclNld_on_date, $tclNldOffDate, $tclNldEnergyRevenue);
	$tclRedwinTenancy = prepareNoOfTenancy($period, $firstDate, $tclRedwin_on_date, $tclRedwinOffDate, $tclRedwinEnergyRevenue);
	$tclWimaxTenancy = prepareNoOfTenancy($period, $firstDate, $tclWimax_on_date, $tclWimaxOffDate, $tclWimaxEnergyRevenue);
	$ttslCdmaTenancy = prepareNoOfTenancy($period, $firstDate, $ttslCdma_on_date, $ttslCdmaOffDate, $ttslCdmaEnergyRevenue);
	$ttslTenancy = prepareNoOfTenancy($period, $firstDate, $ttsl_on_date, $ttslOffDate, $ttslEnergyRevenue);
	$vodafoneTenancy = prepareNoOfTenancy($period, $firstDate, $vodafone_on_date, $vodafoneOffDate, $vodafoneEnergyRevenue);
...
function prepareNoOfTenancy($period, $firstDate, $onDate, $offDate, $energyRevenue) {
	$tenancyOnSite = 0;
	if($onDate != '' && $offDate == '' && $energyRevenue == ''){
		$tenancyOnSite = 1;
	}
	else if($onDate != '' && $offDate != '' && $energyRevenue == ''){
		if(substr($offDate,3) == $period){
			$tenancyOnSite = 1;
		}
	}
	else if($onDate != '' && $offDate != '' && $energyRevenue != ''){
...
// 	if($bts1_on_date != '' && $bts1_type == 'Indoor')
// 		return true;
// 	else if($bts2_on_date != '' && $bts2_type == 'Indoor')
// 		return true;
// 	else if($bts3_on_date != '' && $bts3_type == 'Indoor')
// 		return true;
// 	else if($bts4_on_date != '' && $bts4_type == 'Indoor')
// 		return true;
// 	else if($bts5_on_date != '' && $bts4_type == 'Indoor')
// 		return true;
// 	else if($bts6_on_date != '' && $bts6_type == 'Indoor')
// 		return true;
// 	else return false;
