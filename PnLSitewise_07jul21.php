...
$sql = "select t1.*, 
(case when t1.airtel_bts1_type = 'ID' || t1.airtel_bts2_type = 'ID' || t1.airtel_bts3_type = 'ID' || t1.airtel_bts4_type = 'ID' || t1.airtel_bts5_type = 'ID' || 
t1.airtel_bts6_type = 'ID' then 'Yes' else 'No' end) as airtel_have_ID, 
(case when t1.bsnl_bts1_type = 'ID' || t1.bsnl_bts2_type = 'ID' || t1.bsnl_bts3_type = 'ID' || t1.bsnl_bts4_type = 'ID' || t1.bsnl_bts5_type = 'ID' || 
t1.bsnl_bts6_type = 'ID' then 'Yes' else 'No' end) as bsnl_have_ID, 
(case when t1.idea_bts1_type = 'ID' || t1.idea_bts2_type = 'ID' || t1.idea_bts3_type = 'ID' || t1.idea_bts4_type = 'ID' || t1.idea_bts5_type = 'ID' || 
t1.idea_bts6_type = 'ID' then 'Yes' else 'No' end) as idea_have_ID, 
(case when t1.pbHfcl_bts1_type = 'ID' || t1.pbHfcl_bts2_type = 'ID' || t1.pbHfcl_bts3_type = 'ID' || t1.pbHfcl_bts4_type = 'ID' || t1.pbHfcl_bts5_type = 'ID' || 
t1.pbHfcl_bts6_type = 'ID' then 'Yes' else 'No' end) as pbHfcl_have_ID, 
(case when t1.rjio_bts1_type = 'ID' || t1.rjio_bts2_type = 'ID' || t1.rjio_bts3_type = 'ID' || t1.rjio_bts4_type = 'ID' || t1.rjio_bts5_type = 'ID' || 
t1.rjio_bts6_type = 'ID' then 'Yes' else 'No' end) as rjio_have_ID, 
(case when t1.sify_bts1_type = 'ID' || t1.sify_bts2_type = 'ID' || t1.sify_bts3_type = 'ID' || t1.sify_bts4_type = 'ID' || t1.sify_bts5_type = 'ID' || 
t1.sify_bts6_type = 'ID' then 'Yes' else 'No' end) as sify_have_ID, 
(case when t1.tclIot_bts1_type = 'ID' || t1.tclIot_bts2_type = 'ID' || t1.tclIot_bts3_type = 'ID' || t1.tclIot_bts4_type = 'ID' || t1.tclIot_bts5_type = 'ID' || 
t1.tclIot_bts6_type = 'ID' then 'Yes' else 'No' end) as tclIot_have_ID, 
(case when t1.tclNld_bts1_type = 'ID' || t1.tclNld_bts2_type = 'ID' || t1.tclNld_bts3_type = 'ID' || t1.tclNld_bts4_type = 'ID' || t1.tclNld_bts5_type = 'ID' || 
t1.tclNld_bts6_type = 'ID' then 'Yes' else 'No' end) as tclNld_have_ID, 
(case when t1.tclRedwin_bts1_type = 'ID' || t1.tclRedwin_bts2_type = 'ID' || t1.tclRedwin_bts3_type = 'ID' || t1.tclRedwin_bts4_type = 'ID' || t1.tclRedwin_bts5_type = 'ID' || 
t1.tclRedwin_bts6_type = 'ID' then 'Yes' else 'No' end) as tclRedwin_have_ID, 
(case when t1.tclWimax_bts1_type = 'ID' || t1.tclWimax_bts2_type = 'ID' || t1.tclWimax_bts3_type = 'ID' || t1.tclWimax_bts4_type = 'ID' || t1.tclWimax_bts5_type = 'ID' || 
t1.tclWimax_bts6_type = 'ID' then 'Yes' else 'No' end) as tclWimax_have_ID, 
(case when t1.ttslCdma_bts1_type = 'ID' || t1.ttslCdma_bts2_type = 'ID' || t1.ttslCdma_bts3_type = 'ID' || t1.ttslCdma_bts4_type = 'ID' || t1.ttslCdma_bts5_type = 'ID' || 
t1.ttslCdma_bts6_type = 'ID' then 'Yes' else 'No' end) as ttslCdma_have_ID, 
(case when t1.ttsl_bts1_type = 'ID' || t1.ttsl_bts2_type = 'ID' || t1.ttsl_bts3_type = 'ID' || t1.ttsl_bts4_type = 'ID' || t1.ttsl_bts5_type = 'ID' || 
t1.ttsl_bts6_type = 'ID' then 'Yes' else 'No' end) as ttsl_have_ID, 
(case when t1.vodafone_bts1_type = 'ID' || t1.vodafone_bts2_type = 'ID' || t1.vodafone_bts3_type = 'ID' || t1.vodafone_bts4_type = 'ID' || t1.vodafone_bts5_type = 'ID' || 
t1.vodafone_bts6_type = 'ID' then 'Yes' else 'No' end) as vodafone_have_ID 
from (
...
from (
SELECT `Site ID ( SAP ID)` as site_id, `VIL_Site_Master`.`Site Name` as site_name, `Opco Circle Name` as opco_circle_name, 
...
'..' as ttslDays,  
'..' as vodafoneDays, 
SUM(`RJIO_Output_April`.`Cabex_DG`) as rjio_dg_amount, sum(`RJIO_Output_April`.`Cabex_EB`) as rjio_eb_amount, 
...
'..' airtel_link_off_date, '..' bsnl_link_off_date, '..' idea_link_off_date, '..' pbHfcl_link_off_date, '..' rjio_link_off_date, '..' sify_link_off_date, '..' tclIot_link_off_date, '..' tclNld_link_off_date, '..' tclRedwin_link_off_date, '..' tclWimax_link_off_date, '..' ttslCdma_link_off_date, '..' ttsl_link_off_date, '..' vodafone_link_off_date 
FROM `RJIO_Output_April` where `RJIO_Output_April`.`Period` = '$period' group by `RJIO_Output_April`.`TVI Site ID` 
UNION 
