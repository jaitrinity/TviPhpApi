...
$fields = array('SRNo','telecom_circle','billing_state','sub_state_name','billing_type','bp_code','billing_nature','operator_name','enery_type','billing_month','billing_start_date','billing_end_date','site_id','site_name','tenancy','diesel_rate','diesel_share','dg_cabex','eb_from_date','eb_end_date','no_of_days','eb_unit_rate','eb_share','eb_cabex','total','total_cabex'); 
...
while($roww = mysqli_fetch_assoc($billingResult2)){
	...
	$lineData = array($roww['SRNo'], $roww['telecom_circle'], $roww['billing_state'], $roww['sub_state_name'], 
		$roww['billing_type'],
		$roww['bp_code'], $roww['billing_nature'], $roww['operator_name'], $roww['enery_type'], 
		$roww['billing_month'], $roww['billing_start_date'], $roww['billing_end_date'], $roww['site_id'], 
		$roww['site_name'], $roww['tenancy'], $roww['diesel_rate'], $roww['diesel_share'], $roww['dg_cabex'], 
		$roww['eb_from_date'], $roww['eb_end_date'], $roww['no_of_days'], $roww['eb_unit_rate'], 
		$roww['eb_share'], $roww['eb_cabex'], 
		$roww['total'], $roww['total_cabex']);
...
header("Content-Disposition: attachment; filename=billingReport.xls");
