...
$sql = "SELECT `Operator`, `SR_NUMBER`, `CIRCLE_NAME`, `NB01`, `NB02Date`, `NB02`, `NB03Date`, `NB03`, `NB04Date`, `NB04`, `NB05Date`, `NB05`, `NB06Date`, `NB06`, `NB07Date`, `NB07`, `NB08Date`, `NB08` FROM `Opco_SU_Audit` ";
...
$columnNameArr=["Type", "SP Submission","Release SO","Approve SO","RFAI WIP","RFAI Declaration","AT Acceptance","RFS Acceptance"]; 
$excelColName=array();
for($cc=0;$cc<count($columnNameArr);$cc++){
	$colValue = $columnNameArr[$cc];
	$colIndex = $cc+1;
...
$sql = "SELECT `Type`, `NB02`, `NB03`, `NB04`, `NB05`, `NB06`, `NB07`, `NB08` FROM `Opco_SU_Aging`";
$query = mysqli_query($conn,$sql);	
$lastColName="";
$cellRow = 1;
while($row = mysqli_fetch_assoc($query)){
...
$filename = "Site Upgrade - Audit & Aging Report";
